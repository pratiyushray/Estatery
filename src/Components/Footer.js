...
function Footer() {
  ...
  return (
    <div className='mt-8'>
        ...
        <div className='footer text-black text-center pt-4 pb-4' onClick={scrollToTop}>
            <button className='btn__back' onClick={scrollToTop}>Back to top</button>
        </div>  
        <hr/>
            <div className="grid grid-cols-2 gap-8 px-6 py-8 md:grid-cols-4">
                <div>
                    <h2 className="mb-6 text-sm font-semibold text-black uppercase dark:text-gray-400">Company</h2>
                ...
                <div>
                    <h2 className="mb-6 text-sm font-semibold text-black uppercase dark:text-gray-400">Help center</h2>
                    <ul className="text-black dark:text-gray-400">
                        <li className="mb-4">
                ...
                <div>
                    <h2 className="mb-6 text-sm font-semibold text-black uppercase dark:text-gray-400">Download</h2>
                    <ul className="text-black dark:text-gray-400">
                        <li className="mb-4">
            ...
            <div className="px-4 py-6 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
                <span className="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2023 <a href="/">Estatery™</a>. All Rights Reserved.
                </span>
